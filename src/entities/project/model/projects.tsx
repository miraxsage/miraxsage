"use client";
import { TechnologiesList } from "@/entities/resume/ui/blocks/specs/Technologies";
...
export type ProjectsType = typeof _staticProjects;

export type ProjectsList = ProjectsType[number & keyof ProjectsType]["slug"];

let _runtimeProjects: ProjectInterface[] | null = null;

export function setProjectsData(data: ProjectInterface[]) {
    _runtimeProjects = data;
}

export function getProjectsArray(): ProjectInterface[] {
    return _runtimeProjects ?? (_staticProjects as unknown as ProjectInterface[]);
}
