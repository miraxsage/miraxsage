...
import { LinkButton } from "@/shared/ui/DescriptionPanel";
...
import {
    ...
    navigateToProjects,
    useProjectsLocation,
} from "@/entities/project/lib/projectsNavigation";
                ...
                <ProjectsBreadcrumbs
                    ...
                    onBack={
                        !curProjectLocation
                            ? undefined
                            : () => {
                                  navigateToProjects(router, { project: "all" }, curProjectLocation);
                              }
                    }
                />
                <motion.div
                                        ...
                                        {content.current[lang] ? (
                                            ...
                                            >
                                                <CustomScrollbar top="5px" bottom="5px" right="4.5px">
                                                    {
                                                        <Box
                                                            className={screenMode.full ? "container mx-auto" : ""}
                                                            sx={{
                                                                width: "100%",
                                                                "&.container": {
