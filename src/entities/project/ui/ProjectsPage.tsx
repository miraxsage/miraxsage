...
import ProjectFiltersList from "@/features/project-filter/FiltersList";
...
import { navigateToProjects, projectsOrderItems, useProjectsLocation } from "@/entities/project/lib/projectsNavigation";
            ...
            >
                ...
                >
                    <CategoriesToolbar
                        ...
                        onFilterClear={() => navigateToProjects(router, { techs: [] }, projectsLocation)}
                    />
                        ...
                        >
                            {getProjectsArray()
                                ...
                                .map((p) => (
                                    <ProjectCard
                                        onClick={() =>
                                            navigateToProjects(router, { project: p.slug }, projectsLocation)
                                        }
