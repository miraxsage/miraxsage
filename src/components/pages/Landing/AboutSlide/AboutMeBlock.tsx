...
export default function AboutMeBlock() {
    ...
    return (
        <AboutBlock illustration={<WebDeveloperIllustration />} order="right" title={["Обо", "мне", "👨‍💻"]}>
            {lang.ru ? (
                <>
                    Программированием <Emoji e="📟" /> и веб-разработкой я увлекся еще в 11 классе <Emoji e="🌱" />,
                    далеком 2010-м.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    И тогда и до сих пор не терял творческого интереса и вдохновения программировать, проектировать,
                    порой часами исправлять единственный баг <Emoji e="🐞" />, но в итоге все равно всегда находить
                    решение. <Emoji e="⛅️" />
                </>
            ) : (
                <>
