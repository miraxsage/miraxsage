// Auto-generated by scripts/generate-mui-icon-names.mjs
// Do not edit manually. Run: node scripts/generate-mui-icon-names.mjs

const muiIconNames: string[] = [
  "Abc",
  "AcUnit",
  "AccessAlarm",
  "AccessAlarms",
