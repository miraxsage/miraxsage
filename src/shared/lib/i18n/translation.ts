import staticRu from "./locales/ru.json";
import type { TranslationsMap } from "./getTranslations";

let dynamicMap: TranslationsMap | null = null;

export function setTranslationsMap(map: TranslationsMap) {
    dynamicMap = map;
}
...
let _currentLang: "en" | "ru" = "ru";

export function setCurrentLanguage(lang: "en" | "ru") {
    _currentLang = lang;
}
